...
namespace TicTacToe
{
    public partial class PlayerVComputerHard : Form
    {
        ...
        {
            if (lineTotals.Row1 == -2 || lineTotals.Row2 == -2 || lineTotals.Row3 == -2 ||
                lineTotals.Column1 == -2 || lineTotals.Column2 == -2 || lineTotals.Column3 == -2 ||
                lineTotals.Diag1 == -2 || lineTotals.Diag2 == -2)
            {
                ComputerMoveAttack();
            }
            else
        ...
        private void ComputerMoveAttack()
        {
            if (lineTotals.Row1 == -2)
            {
        ...
        private void ComputerMoveBlock()
        {
            if (lineTotals.Row1 == 2)
            {
                if (button7.Enabled == true)
